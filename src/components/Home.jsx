  ...
  return (
    <div>
      <div className='text-center p-10'>
        ...
        <p className='text-md py-5 leading-5 text-gray-400'>
          An ambitious and dedicated undergraduate software engineer with a passion for crafting innovative solutions through code. 
        </p>
      </div>
